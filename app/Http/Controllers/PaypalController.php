...
//        parent::__construct();
    ...
    //    dump($payment_id);
        ...
        if ($result->getState() == 'approved') {
            ...
            Session::put('checkout.refno', $invoice2['booking_reference_id']);
            //$invoice2['paypal_packages'] = DB::table('product_to_quantity_discount')->where('product_id',$invoice2['cart']['product'][0]['product_id'])->get();
