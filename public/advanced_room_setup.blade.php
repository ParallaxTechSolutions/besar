                ...
                <div class="portlet-body">
                  ...
                  <br/>
                    ...
                    <form id="update_adv_room_data" method="post" enctype="multipart/form-data">
                                        ...
                                        @foreach($table_data as $key2 => $val2)
                                            ...
                                            <tr class="room_type_row" product_id="{{$product_id}}">
                                              ...
                                              <td class="head-col">
                                                ...
                                                <a style="display: {{($first_status != 1 ? 'none' : '')}}" class="btn-xs btn-success plm changeStatusAll" data-hover="tooltip" data-placement="top" title="" data-original-title="Open"></a>

                                                <a style="display: {{($first_status == 1 ? 'none' : '')}}" class="btn-xs btn-dark plm changeStatusAll" data-hover="tooltip" data-placement="top" title="" data-original-title="Closed"></a>
                                              </td>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td>
                                                            ...
                                                            <input name="update[{{$val3->id}}][sale_price]" type="text" class="form-control text-12px price_box" placeholder="Room Price" value="{{$val3->sale_price}}" data-hover="tooltip" data-placement="top" title="" style="width: 45px" data-original-title="Room Price">
                                                          </td>
                                                          <td>
                                                            <input name="update[{{$val3->id}}][qty_stock]" type="text" class="form-control text-12px qty_box" placeholder="Available Unit" value="{{$val3->qty_stock}}" data-hover="tooltip" data-placement="top" title="" style="width: 40px;" data-original-title="Available Unit">
                                                          </td>
                                                        </tr>
                      ...
                      <div class="clearfix"></div>
                      <div class="form-actions text-center"> <button class="btn btn-red tableSaveBtn">Save &nbsp;<i class="fa fa-save"></i></button> </div>
                      <?php
                    }
                    else
                    {
