...
<div class="main-container-custom"style="margin-top: -22px;">
...
<li><a href="{{ url('/about_us_edit') }}"><i class="fa fa-user fa-fw"></i><span class="menu-title">About Us</span></a> </li>
                  <li><a href="#"><i class="fa fa-briefcase fa-fw"></i><span class="menu-title">Careers</span><span class="fa arrow"></span></a>
                    ...
                    <li ><a href="#"><i class="fa fa-shopping-cart fa-fw"></i><span class="menu-title">Bookings</span>
                        ...
                        <ul @if(Request::path() == 'web88cms/orders/shipmentsList' || Request::path() == 'web88cms/orders' || Request::path() == 'web88cms/settings' || Request::path() == 'web88cms/analytics_reports' || Request::path() == 'web88cms/checkInOut') class="nav nav-second-level collapse in" style="height: auto;" @else class="nav nav-second-level collapse" @endif>
                            ...
                            <li @if(Request::path() == 'web88cms/settings') class="active" @endif><a href="{{ url('web88cms/settings') }}">DDR Settings</a></li>
                    ...
                    <li @if(preg_match('/PropertiesController/',$current_route)) class="active" @endif><a href="{{ url('/web88cms/property') }}"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Properties</span></a></li>
                ...
                <!-- <li @if(Request::path() == 'web88cms/promotions_list') class="active" @endif><a href="{{ url('/web88cms/promotions_list') }}"><i class="fa fa-coffee fa-fw"></i><span class="menu-title">Promotions</span></a> </li> -->
                    ...
                    <li @if(Request::is('web88cms/promocodes/*') ) class="active" @endif><a href="{{ url('/web88cms/promocodes') }}"><i class="fa fa-qrcode fa-fw"></i><span class="menu-title">Promo Codes</span></a></li>
                ...
                <!-- <li @if(Request::path() == 'web88cms/left_banner_list') class="active" @endif><a href="{{ url('/web88cms/left_banner_list') }}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Left Banners</span></a></li>
                    ...
                    {{-- <li><a href="{{ url('web88cms/index_edit') }}"><i class="fa fa-home"></i><span class="menu-title">Home Content</span></a> </li> --}}
                    ...
                    <li><a href="{{ url('/web88cms/notifications') }}"><i class="fa fa-check-circle"></i><span class="menu-title">Notifications Settings</span></a></li>
                    <li><a href="header_setup"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Header Setup</span></a></li>

                    <li><a href="footer_setup"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Footer Setup</span></a></li>
                </ul>
            </div>
        </nav>
