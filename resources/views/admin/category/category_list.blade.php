...
<link type="text/css" rel="stylesheet" href="{{ asset('/public/admin/css/waitMe.css') }}" />
...
<script type="text/javascript">
	var savelistURl = "{{ url('web88cms/categories/saveCategoryChanges') }}";
...
<script src="{{ asset('/public/admin/js/waitMe.js') }}"></script>
