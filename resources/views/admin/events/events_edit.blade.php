<?php
    ...
    ->where(array('page' => 'events'))->get();
    //->where(array('page' => 'events','type' => 'images'))->get();
?>
...
<div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-lg-12">
                <h2>Events <i class="fa fa-angle-right"></i> Edit</h2>
                 ...
                 <div class="row">
                    ...
                    <div class="portlet">
                        <div class="portlet-header">
                            <div class="caption" style="float:none">Events Page Heading</div>
                            <br/>
               ...
               {{--  <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">events Page Heading</div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <form method="post" action="{{URL('/web88cms/events_header_editor')}}" id="wbx_change_info_heading">
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Events Page Left Content</div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="events[]" contenteditable="true">
                                {{-- {{ dd($data) }} --}}
                        ...
                        <form method="post" action="{{URL('/web88cms/events_editor')}}" id="wbx_change_info">
                          <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                        </form>
                ...
                {{-- <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">events Mid Content </div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <form method="post" action="{{URL('/web88cms/events_mid_editor')}}" id="wbx_change_info_mid">
                          <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                        </form>
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Events Left Content </div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <form method="post" action="{{URL('/web88cms/events_left_editor')}}" id="wbx_change_info_left">
                          <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                        </form>
                                            ...
                                            @if(isset($page_images) && !empty($page_images))
                                                @foreach ($page_images as $key => $value)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $value->type }}</td>
                                                        <td>
                                                            <img src="{{asset('/public/images/events/'.$value->image) }}" style="height:75px">
                                                        </td>
                                                        <td>{{ $value->order }}</td>
                                                                                ...
                                                                                <form class="form-horizontal" method="post"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <div class="text-15px margin-top-10px">
                                                                                                <?php if($value->image){?>
                                                                                                <img src="<?php echo "https://" . $_SERVER['HTTP_HOST'] . '/public/images/events/', $value->image?>"
                                                                                                     alt="Image"
