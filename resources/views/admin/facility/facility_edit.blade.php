<?php
    ...
    ->where(array('page' => 'facilities'))->get();
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="portlet">
                    ...
                    <div class="portlet">
                        <div class="portlet-header">
                            <div class="caption" style="float:none">Facilities Page Heading</div>
                            <br/>
                    ...
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="facility[0]" contenteditable="true">
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Facility Page Right Content 1</div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="facility[1]" contenteditable="true">
                                {!! html_entity_decode((isset($data[1]) ? $data[1] : '')) !!}
                            </div>
                        </section>
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Facility Page Left Content 1</div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="facility[2]" contenteditable="true">
                                {!! html_entity_decode((isset($data[2]) ? $data[2] : '')) !!}
                            </div>
                        </section>
                    </div>
                    <div class="form-actions none-bg"> 
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Facility Page Right Content 2</div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="facility[3]" contenteditable="true">
                                {!! html_entity_decode((isset($data[3]) ? $data[3] : '')) !!}
                            </div>
                        </section>
                    </div>
                    <div class="form-actions none-bg"> 
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Facility Page Left Content 2</div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="facility[4]" contenteditable="true">
                                {!! html_entity_decode((isset($data[4]) ? $data[4] : '')) !!}
                            </div>
                        </section>
                    </div>
                    <div class="form-actions none-bg"> 
                                                ...
                                                <div class="form">
                                                    <form id="addObj" class="form-horizontal" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="name" rows="3" class="form-control" placeholder="e.g. Health-Centre">
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="text-15px margin-top-10px"> <img src="../../images/testimonialsbg.jpg" alt="Facility" class="img-responsive hidden">
                                                                    <br/>
                                                        ...
                                                        <script>
                                                            function addFacility() {
                                                                ...
                                                                $.ajax({
                                                                    // url: 'facilityAdd',
                                                                    url: APP_URL + '/web88cms/facilities_edit/facilityAdd',
                                                                    type: 'post',
                                                                    dataType: 'json',
                                                                    data: form_data,
                                ...
                                <div class="table-responsive mtl">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            //$i=1;
                                            foreach($facilities as $key1 => $facility) { ?>
                                                <tr>
                                                    {{--
                                                    <td>
                                                        <input type="checkbox" />
                                    ...
                                    <?php                                      
                                        if(isset($totalFacilities) and $totalFacilities!=''){ 
                                            $totalPage = ceil($totalFacilities/$item);
                                        }else{
                                            $totalPage=0;   
                                        }
                                    ...
                                    <p class="pull-left">Showing
                                        <?php if($page>1){ echo (($page-1)*$item)+1;}else{ echo 1;}?> to
                                            <?php echo $i-1;?> of
                                                <?php echo $totalFacilities;?> entries</p>
                                    <ul class="pagination pagination mtm mbm">
                                        <?php if($page<=1 and $totalPage<=1){ $class1 = "disabled"; }else{ $class1 = ""; }?>
                                            <li class="<?php echo $class1;?>"><a href="<?= url('web88cms/facilities_edit/'.$item.'/'.($page-1), $parameters = [], $secure = null); ?>">&laquo;</a></li>

                                            <?php if ($page > $howMany + 1): ?>
                                                <li><a href="<?= url('web88cms/facilities_edit/'.$item.'/'.($page-1), $parameters = [], $secure = null); ?>">...</a></li>
                                                <?php endif; ?>
                                                    ...
                                                    <?php for ($pageIndex = $page - $howMany; $pageIndex <= $page + $howMany; $pageIndex++):  if($pageIndex==$page){ $active='active';}else{ $active='';}?>
                                                        <?php if ($pageIndex >= 1 && $pageIndex <= $totalPage): ?>
                                                            <li class="<?php echo $active;?>">
                                                                <a href="<?= url('web88cms/facilities_edit/'.$item.'/'.$pageIndex, $parameters = [], $secure = null); ?>">
                                                                    <?php echo $pageIndex?>
                                                                </a>
                                                            </li>
                                                            <?php endif; ?>
                                                                    ...
                                                                    <?php if ($page < $totalPage - $howMany): ?>
                                                                        ...
                                                                        <?php endif; ?>
                                                                            ...
                                                                            <?php if($totalPage<=1 and $page>=$totalPage){ $class2 = "disabled"; }else{ $class2 = ""; }?>
                                                                                <li class="<?php echo $class2;?>"><a href="<?= url('web88cms/facilities_edit/' .$item.'/'.($page+1), $parameters = [], $secure = null); ?>">&raquo;</a></li>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                {{-- {{ dd($page['title']) }} --}}
                                                <td>
                                                    @if($fpage['status'] == NULL)
                                                    <span class="label label-sm label-warning">Inctive</span> @else
                                                    <span class="label label-sm label-success">Active</span> @endif
                                                </td>
                                                <td>{{ ($fpage['title'])?$fpage['title']:'No Title' }}</td>
                                                <td>
                                                    @if($fpage['background'])
                                                    <img id="backgroundHolder" src="{{ asset($fpage['background']) }}" style="width: 200px;height: 75px;"> @else No Background @endif
                                                </td>
                                                                    ...
                                                                    <div class="form">
                                                                        <form id="bgImg" class="form-horizontal" method="post">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div data-on="success" data-off="primary" class="make-switch">
                                                                                        <input name="status" value="1" type="checkbox" <?php if($fpage[ 'status']){?>checked="checked"
                                                                                        <?php } ?>/>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <input id="title" name="title" value="{{ $fpage['title']}}" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            @if($fpage['background'])
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-5">
                                                                                    <div data-on="success" data-off="primary" class="make-switch" style="border:none !important">
                                                                                        <img id="backgroundHolder" src="{{ asset($fpage['background']) }}" style="width: 200px;height: 75px;">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            @endif
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <div class="text-15px margin-top-10px"> 
                                                                                        {{-- <img src="../../images/testimonialsbg.jpg" alt="Objective" class="img-responsive"> --}}
                                                                                        {{-- <br/> --}}
                                                                            ...
                                                                            <input type="hidden" name="old_background" value="{{ $fpage['background'] }}">
                                                                            <div class="form-actions">
                                                                        ...
                                                                        <script>
                                                                            function backgroundUpdate() {
                                                                                ...
                                                                                $.ajax({
                                                                                    ...
                                                                                    url: APP_URL + '/web88cms/backgroundUpdate',
                                                                                    type: 'post',
                                                                                    dataType: 'json',
                                                                                    data: form_data,
                                                                                    enctype: 'multipart/form-data',
                                                    ...
                                                    <div class="form">
                                                        <form id="addVideo" class="form-horizontal" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input name="title" rows="3" class="form-control" placeholder="e.g. Front Video">
                                                                </div>
                                                                <div class="col-md-3"> </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input name="video" type="url" rows="3" class="form-control" placeholder="e.g www.youtube.com/X576555SDF">
                                                                </div>
                                                                <div class="col-md-3"> </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">Upload Video Backgound <span class='require'>*</span></label>
                                                                <div class="col-md-9">
                                                                    <div class="text-15px margin-top-10px"> 
                                                                        {{-- <img src="../../images/testimonialsbg.jpg" alt="Facility" class="img-responsive"> --}}
                                                                        <br/>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="form">
                                                                                ...
                                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ url('/web88cms/videoUpdate') }}">
                                                                                    ...
                                                                                    </div> --}} @if($video->background)
                                                                                    <input type="hidden" name="old_background" value="{{ $video->background }}"> @endif
                                                                                    <input type="hidden" name="objId" value="<?php echo $video->id;?>" /> @if($video->background)
                                                                                    <div class="form-group">
                                                                                        <label class="col-md-3 control-label">Previous Video Background </label>
                                                                                        <div class="col-md-5">
                                                                                            <div data-on="success" data-off="primary" class="make-switch" style="border:none !important">
                                                                                                <img src="{{ asset($video->background) }}" style="width: 50px;height: 50px;">
                                                                                            </div>
                                                                                    ...
                                                                                    @endif
                                                                                    <div class="form-group">
                                                                                        <label class="col-md-3 control-label">Upload Video Backgound</label>
                                                                                        <div class="col-md-9">
                                                                                            <br/>
                                            ...
                                            @if(isset($page_images) && !empty($page_images))
                                                @foreach ($page_images as $key => $value)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $value->type }}</td>
                                                        <td>
                                                            <img src="{{asset('/public/images/facilities/'.$value->image) }}" style="height:75px">    
                                                        </td>
                                                        <td>{{ $value->order }}</td>
                                                        <td><a href="#" data-hover="tooltip" data-placement="top"
                                                               data-target="#modal-edit-banner-images{{ $key }}"
                                                               data-toggle="modal" title="Edit"><span
                                                                        class="label label-sm label-success"><i
                                                                            class="fa fa-pencil"></i></span></a> <a href="#"
                                                                                                                    ...
                                                                                                                    data-placement="top"
                                                                                                                    title="Delete"
                                                                                                                    data-target="#modal-delete-images-{{ $key }}"
                                                                                                                    data-toggle="modal"><span
                                                                        class="label label-sm label-red"><i
                                                                            class="fa fa-trash-o"></i></span></a>
                                                            <!--Modal Edit banner start-->
                                                            <div id="modal-edit-banner-images{{ $key }}" tabindex="-1"
                                                                                ...
                                                                                <form class="form-horizontal" method="post"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <div class="text-15px margin-top-10px">
                                                                                                <?php if($value->image){?>
                                                                                                <img src="<?php echo "https://" . $_SERVER['HTTP_HOST'] . '/public/images/facilities/', $value->image?>"
                                                                                                     alt="Image"
                                                            ...
                                                            <!--Modal delete start-->
                                                            <div id="modal-delete-images-{{ $key }}" tabindex="-1" role="dialog"
...
<script>
    ...
    $('.wbx_submit_publish_right').click(function(e) {
        e.preventDefault();
        $('.wbx_info_right').each(function(i, e) {
            // var value = addslashes($(e).html());
            var value = $(e).html();
            var name = $(e).attr('name');
            $check = 1;
            // $('#wbx_change_info').append("<input type='hidden' name='" + name + "' value='" + value + "' />");
            $('#wbx_change_info_right').append('<textarea style="display: none" name="' + name + '">' + value + '</textarea>');
            $('#wbx_change_info_right').append('<input type=hidden value="' + $check + '" name="wbx_publish">');
        });
        $('#wbx_change_info_right').submit();
    });
