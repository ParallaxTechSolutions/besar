...
<div id="page-wrapper">
    <div class="page-header-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Tax Rates - Listing</li>
        </ol>
    </div>
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-lg-12">
                <h2>Tax Rates <i class="fa fa-angle-right"></i> Listing</h2>
            ...
            <div class="col-lg-12">
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Tax Rates Listing</div>
                        <div class="clearfix"></div>
                                        ...
                                        <div class="form">
                                            <form id="add-new-gstrate-form" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text"  class="form-control" name="name" placeholder="eg. Tax Rates">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-actions">
                                                                <div class="col-md-offset-4 col-md-8">
                                                                    <a href="{{ url('web88cms/taxrates/delete/' . $gstrate->id) }}?redirect=<?php echo urlencode($curr_url); ?>" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp;
...
//Create new Tax Rates
                                                                                ...
                                                                                $.ajax({
                                                                                url: "{{ url('web88cms/taxrates/newGstrate') }}",
                                                                                        type: 'POST',
...
//Create new user
                                                                                ...
                                                                                $.ajax({
                                                                                url: "{{ url('web88cms/taxrates/editGstrate') }}/" + id,
                                                                                        type: 'POST',
...
//Delete
                                                                                ...
                                                                                if (total > 0) {
                                                                                $.ajax({
                                                                                url: "{{ url('web88cms/taxrates/deleteAllGstrate') }}",
                                                                                        type: 'POST',
                                                                                        data: values,
                                                                                        dataType: 'json',
                                                                                        async: false,
                                                                                ...
                                                                                alert('Please select at least one Tax Rate before delete.');
                                                                                }
                                                                                }
...
<?php if ($_SERVER['QUERY_STRING']) { ?>
                                                                                    window.location = '<?= url("web88cms/taxrates"); ?>/' + $(this).val() + "?<?= $_SERVER['QUERY_STRING']; ?>";
<?php } else { ?>
                                                                                    window.location = '<?= url("web88cms/taxrates"); ?>/' + $(this).val();
<?php } ?>
                                                                                });
                                                                                });
