              ...
              <table class="table table-hover table-striped">
                ...
                <script>
                  ...
                  <tr>
                    ...
                    <td><?php 
						$input= $details->start_date; 
						$date1 = \DateTime::createFromFormat('Y-m-d', $input);
						echo $date1->format('dS M, Y');

						$new_date = $date1->format('d-m-Y');
						?></td>
                    <td><?php
					$input2= $details->end_date;
						$date2 = \DateTime::createFromFormat('Y-m-d', $input2);
						echo $date2->format('dS M, Y');
						
						$endnew_date = $date2->format('d-m-Y');
							   ?>
							   </td>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      <div class="input-group ">
                                        <input type="text" name="start_date" class="form-control datepicker" id="start_date" placeholder="1st Mar, 2015" value="<?php
                                                echo $new_date;
                                               ?>" required="required"/>
                                        <span class="input-group-addon">to</span>
                                        <input type="text" name="end_date" class="form-control datepicker" id="end_date" placeholder="03rd Mar ,2015" value="<?php echo $endnew_date; ?>" required="required"/>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      <?php if($details->banner!='')
                           {?>
                                    <p><img src="<?php echo "https://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/top/'. $details->banner?>" class="img-responsive" /></p>
                          <?php } ?>
                                    <div class="form-actions">
