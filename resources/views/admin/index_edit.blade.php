<?php
    ...
    // ->where(array('page' => 'home'))->get();
    ->where(array('page' => 'home','type' => 'top'))->get();
?>
@extends('adminLayout')
@section('content')
            ...
            <div class="col-lg-12">
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-body">
                        ...
                        <form method="post" action="{{URL('/web88cms/index_editor')}}" id="wbx_change_info">
                                            ...
                                            <div class="modal-body">
                                                <div class="form">
                                                    <form action="{{ url('/web88cms/page_images_list') }}" method="POST"
                                                        ...
                                                        <div class="form-group has-error">
                                                            <label class="col-md-3 control-label">Link <span
                                                                        class="require">*</span></label>
                                                            <div class="col-md-6">
                                                                 <input name="link"
                                                                           required="required"
                                                                           id="text" type="text"
                                                                           class="form-control"
                                                                           placeholder="eg. https://s2.towerregency.com.my"
                                                                           autocomplete="off">
                                                            </div>
                                                        </div>                    
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="text-15px margin-top-10px">
                                                                    ...
                                                                    <br/>
                                                                    <span class="help-block">(Image dimension: 360 x 314 pixels, JPEG/GIF/PNG only, Max. 1MB) </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {{-- <div class="form-group">
                                            ...
                                            @if(isset($page_images) && !empty($page_images))
                                                @foreach ($page_images as $key => $value)
                                                    ...
                                                    <tr>
                                                        ...
                                                        {{-- <td>{{ $value->type }}</td> --}}
                                                        <td>
                                                            <img src="{{asset('/public/images/home/'.$value->image) }}" style="height:75px">    
                                                        </td>
                                                        <td>{{ $value->order }}</td>
                                                                                ...
                                                                                <form class="form-horizontal" method="post"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <div class="text-15px margin-top-10px">
                                                                                                <?php if($value->image){?>
                                                                                                <img src="<?php echo "https://" . $_SERVER['HTTP_HOST'] . '/public/images/home/', $value->image?>"
                                                                                                     alt="Image"
                                                                                                     class="img-responsive" style="width:20%"><br/>
                                                                                                <a href="#"
                                                                                                   data-hover="tooltip"
                                                                                                   data-placement="top"
                                                                                                   title="Delete"
