        ...
        <div class="page-header-breadcrumb">
          <div class="page-heading hidden-xs">
           ...
           <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Index Middle Bottom Banners - Listing</li>
          </ol>
        </div>
...
<div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Index Middle Bottom Banners <i class="fa fa-angle-right"></i> Listing</h2>
         ...
         <div class="clearfix"></div>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Index Middle Bottom Banners Listing</div>
                  <br/>
                    ...
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form  method="post" class="form-horizontal" id="banner_middle_bottom" name="banner_middle_bottom"  action="index_middle_bottom_list/addMiddleBottomBanner" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <div class="text-15px margin-top-10px">
                                    ...
                                    <br/>
                                    <span class="help-block">(Image dimension: 870 x 270 pixels, JPEG/GIF/PNG only, Max. 1MB) </span> </div>
                                </div>
                              </div>
                              <div class="form-group">
                              ...
                              <input type="text" name="end_date" class="form-control" id="end_date" required="required" placeholder="03rd Mar ,2015" /></div>
                                </div>
                              </div>
                              <div class="form-group">
                             ...
                             <span class="help-block">Please enter the page link to link it to the sub page.</span> </div>
                              ...
                              <div class="form-actions">
                                ...
                                <div class="col-md-offset-5 col-md-8"> <a href="#add" onclick="chkSize('0');chkSizebanner('0');chkSizeenlargebanner('0'); addmiddleBottomBanner();" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a onClick="$('.form-horizontal').trigger('reset');" href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                              </div>
                            </form>
                            
                            <script>
								function addmiddleBottomBanner(){
									var form_data = new window.FormData($('#banner_middle_bottom')[0]);
																
									$.ajax({			
										url: 'index_middle_bottom_list/addMiddleBottomBanner',
										type:'post',
										dataType:'json',
										data: form_data,
										...
										success: function(response) {			
											if(response['error'])
											{
												$('#errorMiddleBanner').remove();
												$('#successAddMiddleBanner').remove();
												var error = '<div id="errorMiddleBanner" class="alert alert-danger"><i class="fa fa-times-circle"></i> <strong>Error!</strong>';
												if(response['error']=='This  is already in use.'){
													...
													error += '</div>';
													$('#banner_middle_bottom').before(error);	
												}
												...
												if(response['success'])
												{
													...
													$('#banner_middle_bottom').before(success);
																				
													$('.banner_middle_bottom').live('load');
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <!-- <p><strong>#1:</strong> Banner 1</p>-->
                          <div class="form-actions">
                            <form action="index_middle_bottom_list/deleteselectedmiddlebottombanner" method="post" name="deleteRecord">
                  ...
                  <div id="modal-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8"> <a href="index_middle_bottom_list/deleteselectedAllmiddlebottomdata" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="portlet-body">
                  ...
                  <option <?php if($rec==10)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_bottom_list?rec=10') }}">10</option>
                  <option <?php if($rec==20)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_bottom_list?rec=20') }}">20</option>
                  <option <?php if($rec==30)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_bottom_list?rec=30') }}" >30</option>
                  <option <?php if($rec==50)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_bottom_list?rec=50') }}">50</option>
                  <option <?php if($rec==100)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_bottom_list?rec=100') }}">100</option>
                </select>
                      &nbsp;
                      <label class="control-label">Records per page</label>
                    </div>
                  </div>
                  <div class="pull-right"> <a onclick="document.getElementById('updatedisplaymiddlebottombanner').submit();" href="javascript:" class="btn btn-danger">Update Display Order &nbsp;<i class="fa fa-refresh"></i></a> </div>
                  <div class="clearfix"></div>
                  <br/>
                  <br/>
                  <div class="table-responsive mtl">
                  <table id="tabbambodata" class="table table-hover table-striped">
                    <thead>
                      <tr>
                    ...
                    <script>
                            ...
                            <?php
                            	//foreach($result['banner_allmiddlebottomdata'] as $details){
                                
                               // }
                             ?>
                            
                            <form action="index_middle_bottom_list/updateallmiddlebottombanner" method="post" name="updatedisplaymiddlebottombanner" id="updatedisplaymiddlebottombanner" enctype="multipart/form-data" >
                                <input type="hidden" id="up_csrf_token" name="_token"  value="{{ csrf_token() }}" />
                                <?php foreach($result['banner_allmiddlebottomdata'] as $details)
								{?>
                    		...
                    		<?php
							 	...
							 	$i = $result['start_from'];
								foreach($result['banner_middlebottomdata'] as $details)
								{
                    ...
                    <td><?php $input2= $details->end_date;
                         ...
                         <td>  <input type="text" name="display_order" id="displayorder" onchange="uniquefun(this.value, <?php echo $i;?>);document.getElementById('displayorder_<?php echo $details->id; ?>').value=this.value" class="form-control displayord" value="<?php echo $details->display_order; ?>">
                  </td>
                          ...
                          <div id="modal-edit-banner-<?php echo $details->id; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                            <div class="modal-dialog modal-wide-width">
                              ...
                              <a name="edit"></a>
                                ...
                                <div class="modal-body">
                                  <div class="form">
                                    <form method="post" action="" class="form-horizontal" name="editmiddlebottombanner-<?php echo $details->id; ?>" id="editmiddlebottombanner-<?php echo $details->id; ?>" enctype="multipart/form-data" >
                                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label class="col-md-3 control-label">Title <span class='require'>*</span> </label>
                                        <div class="col-md-6">
                                         <input id="title" required="required" type="text" class="form-control" placeholder="Banner 1" name="title" value="<?php echo $details->title; ?>" >
                                      ...
                                      <div class="form-group">
                                        ...
                                        <?php if($details->banner!='')
												 {?>
                                        <img  alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/middlebottom/', $details->banner?>" class="img-responsive" />
                                        <?php }?>
                                            <br/>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-daterange">
                                             <input type="text" required="required" name="start_date" class="form-control" id="start_date" placeholder="1st Mar, 2015" value="<?php
											    echo $new_date;  ?>"/>
                                        <span class="input-group-addon">to</span>
                                        <input type="text" required="required" name="end_date" class="form-control" id="end_date" placeholder="03rd Mar ,2015" value="<?php echo $endnew_date; ?>"/>
                                  ...
                                  <div class="col-md-9">
									...
									<?php if($details->enlarge_banner!='')
												 {?>
                                    <img alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/middlebottom/', $details->enlarge_banner?>" class="img-responsive" /> <br/>
                                  <br/>  
                                  ...
                                  <div class="col-md-9">
                                    ...
                                    <?php if($details->pdf_link!='')
												 {?>
                                    <a href="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/middlebottom/', $details->pdf_link?>"><?php echo $details->pdf_link;?></a> <br/>
                                    ...
                                    <input type="text" placeholder="http://" class="form-control" name="url" id="url<?php echo $details->id; ?>" onkeyup="urllink('<?php echo $details->id; ?>'); return;" onmouseout="urllink('<?php echo $details->id; ?>'); return;"   value="<?php if(($details->url)!=''){echo $details->url;}  ?>" <?php if(( $details->enlarge_banner!='')||($details->pdf_link!='')){ echo 'disabled="disabled"'; }?>/>
                                      ...
                                      <div class="form-actions">
                                        <div class="col-md-offset-5 col-md-8"> 
                                         <a href="#" onClick="chkSize('<?php echo $details->id; ?>');chkSizebanner('<?php echo $details->id; ?>');chkSizeenlargebanner('<?php echo $details->id; ?>');editmiddlebottombanner(<?php echo $details->id;  ?>);" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a onClick="$('.form-horizontal').trigger('reset');" href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                  </div>
                                    </form>
                                  </div>
                                </div>
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8"> 
                                                ...
                                                <form  name="deleteform" id="deleteform<?php echo $details->id; ?>" method="post" action="index_middle_bottom_list/deleteMiddleBottomBanner" enctype="multipart/form-data" >
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="method" value="deletebottombannerdata" id="deletebottombannerdata">
                                    <input type="hidden" name="id" id="banner_id" value="<?php echo $details->id; ?>" />
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                              <form  name="delete_enlarge" id="delete_enlarge<?php echo $details->id; ?>" method="post" action="index_middle_bottom_list/delete_enlarge" enctype="multipart/form-data" class="delete_enlarge<?php echo $details->id; ?>" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <script>
											function deletemiddleopenlargeBanner<?php echo $details->id; ?>(){
												...
												$.ajax({			
													url: 'index_middle_bottom_list/delete_enlarge',
													type:'post',
													dataType:'json',
													data: form_data,
													enctype: 'multipart/form-data',
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                              <form  name="delete_pdf" id="delete_pdf<?php echo $details->id; ?>" method="post" action="index_middle_bottom_list/delete_enlarge" enctype="multipart/form-data" class="delete_enlarge<?php echo $details->id; ?>" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <script>
											function deletemiddle_top_pdfBanner<?php echo $details->id; ?>(){
												...
												$.ajax({			
													url: 'index_middle_bottom_list/delete_pdf',
													type:'post',
													dataType:'json',
													data: form_data,
													enctype: 'multipart/form-data',
...
<!--pdf trash data end-->   
                  ...
                  <script>
				function editmiddlebottombanner(Id){
					var form_data = new window.FormData($('#editmiddlebottombanner-'+Id)[0]);
												
					$.ajax({			
						url: 'index_middle_bottom_list/updateMiddleBottomBanner',
						type:'post',
						dataType:'json',
						data: form_data,
						enctype: 'multipart/form-data',
						...
						success: function(response) {			
							if(response['error'])
							{
								$('#errorEditMiddleBottomBanner').remove();
								$('#successEditMiddleBottomBanner').remove();
								var error = '<div id="errorEditMiddleBottomBanner" class="alert alert-danger"><i class="fa fa-times-circle"></i> <strong>Error!</strong>';
								...
								if(response['error']=='Please fill unique display order Field..'){
									...
									error += '</div>';
										$('#editmiddlebottombanner-'+Id).before(error);	
								...
								if(response['success'])
								{
									$('#errorEditMiddleBottomBanner').remove();
									$('#successEditMiddleBottomBanner').remove();
									var success = '<div id="successEditMiddleBottomBanner" class="alert alert-success"><i class="fa fa-check-circle"></i> <strong>Success!</strong><p>The information has been saved/updated successfully.<br />Page will be reload in 2 sec, Please Wait....</p></p></div>';
									$('#editmiddlebottombanner-'+Id).before(success);
																
									$('.editmiddlebottombanner-'+Id).live('load');
              ...
              <ul class="pagination pagination mtm mbm">
			   ...
			   {$disabled1= '';}
				echo "<li ".$disabled1."><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_middle_bottom_list?page=1>".'&laquo;'."</a></li> "; // Goto 1st page
			   ...
			   {$active= '';}
			echo "<li ".$active." ><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_middle_bottom_list?page=".$i.">".$i."</a></li> "; 
}; 
          if((isset($_GET['page'])&&($_GET['page']==$total_pages)) || $total_pages==1)
			   ...
			   {$disabled= '';}
            echo "<li ".$disabled."><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_middle_bottom_list?page=$total_pages>".'&raquo;'."</a></li> "; // Goto last page
?>
              </ul>
            </div>
                  <div class="clearfix"></div>
