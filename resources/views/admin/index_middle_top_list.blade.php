...
<div class="page-header-breadcrumb">
  ...
  <ol class="breadcrumb page-breadcrumb">
    ...
    <li class="active">Index Middle Top Banners - Listing</li>
  </ol>
</div>
<div class="page-content">
  <div class="row">
    <div class="col-lg-12">
      <h2>Index Middle Top Banners <i class="fa fa-angle-right"></i> Listing</h2>
      ...
      <div class="portlet">
        <div class="portlet-header">
          <div class="caption">Index Middle Top Banners Listing</div>
          <br/>
            ...
            <div class="modal-dialog modal-wide-width">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form">
                    <form  method="post" class="form-horizontal" id="banner_middle_top" name="banner_middle_top"  action="index_middle_top_list/addMiddleTopBanner" enctype="multipart/form-data">
                        ...
                        <div class="col-md-9">
                          <div class="text-15px margin-top-10px">
                           <input type="file" name="banner" id="banner0" required="required"  onchange="chkSizebanner('0');"/>
                            <br/>
                            <span class="help-block">(Image dimension: 420 x 300 pixels, JPEG/GIF/PNG only, Max. 1MB) </span> </div>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-actions"> 
                        ...
                        <div class="col-md-offset-5 col-md-8"> <a href="#add" onclick="chkSize('0');chkSizebanner('0');chkSizeenlargebanner('0'); addmiddleTopBanner();" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a onClick="$('.form-horizontal').trigger('reset');"  href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                      </div>
                    </form>
                    <script>
								function addmiddleTopBanner(){
									var form_data = new window.FormData($('#banner_middle_top')[0]);
																
									$.ajax({			
										url: 'index_middle_top_list/addMiddleTopBanner',
										type:'post',
										dataType:'json',
										data: form_data,
										...
										success: function(response) {			
											if(response['error'])
											{
												...
												if(response['error']=='This  is already in use.'){
													...
													error += '</div>';
													$('#banner_middle_top').before(error);	
												}
												...
												if(response['success'])
												{
													...
													$('#banner_middle_top').before(success);
																				
													$('.banner_middle_top').live('load');
          ...
          <div id="modal-delete-selected"  tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal topdeleted fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body"> 
                  ...
                  <form action="index_middle_top_list/deleteselectedmiddleTopbanner" method="post" name="deleteRecord">
          ...
          <div id="modal-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-actions">
                    <div class="col-md-offset-4 col-md-8"> <a href="index_middle_top_list/deleteselectedAllmiddletopdata" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="portlet-body">
            ...
            <div class="form-group">
             <?php $rec=10; if(isset($_GET['rec'])&&($_GET['rec']!='')){$rec=$_GET['rec'];}?>
              <select name="select_record" class="form-control" id="select_record" onchange="if (this.value) window.location.href=this.value">
                <option <?php if($rec==10)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_top_list?rec=10') }}">10</option>
                <option <?php if($rec==20)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_top_list?rec=20') }}">20</option>
                <option <?php if($rec==30)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_top_list?rec=30') }}" >30</option>
                <option <?php if($rec==50)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_top_list?rec=50') }}">50</option>
                <option <?php if($rec==100)echo ("selected=selected")?> value="{{ url('/web88cms/index_middle_top_list?rec=100') }}">100</option>
              </select>
              &nbsp;
          ...
          <div class="table-responsive mtl">
            <table class="table table-hover table-striped">
              ...
              <form name="myform" id="myform" action="index_middle_top_list/updateallmiddletopbanner" method="post" enctype="multipart/form-data">
                <input type="hidden" id="up_csrf_token" name="_token"  value="{{ csrf_token() }}" />
                <?php foreach($result['banner_allmiddletopdata'] as $details){?>
               <?php /*?> <input type="hidden" name="myid[]" value="<?php echo $details->id; ?>"  id="myid_<?php echo $details->id; ?>"/><?php */?>
               <input type="hidden" name="myorder[<?php echo $details->id; ?>]" value="<?php echo $details->display_order; ?>" class="form-control"  id="myorder_<?php echo $details->id; ?>"/>
              ...
              <?php
							 	...
							 	$i = $result['start_from'];
								foreach($result['banner_middletopdata'] as $details)
								{
              ...
              <tr>
                ...
                <td><input type="text" class="form-control displayord" value="<?php echo $details->display_order; ?>" onchange="uniquefun(this.value, <?php echo $i;?>);document.getElementById('myorder_<?php echo $details->id; ?>').value=this.value"></td>
                  ...
                  <div id="modal-edit-banner-<?php echo $details->id; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
                      ...
                      <a name="edit"></a>
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal" method="post" action="index_middle_top_list/updateMiddleTopBanner" name="editmiddletopbanner-<?php echo $details->id; ?>" id="editmiddletopbanner-<?php echo $details->id; ?>" enctype="multipart/form-data" >
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <div class="form-group">
                                <label class="col-md-3 control-label">Upload Banner <span class='require'>*</span></label>
                                <div class="col-md-9">
                                  <div class="text-15px margin-top-10px"><!-- <img src="../images/index/middle-banner-1.jpg" alt="Banner" class="img-responsive">--><br/>
                                    <?php if($details->banner!='')
												 {?>
                                    <img  alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/middletop/', $details->banner?>" class="img-responsive" />
                                    <?php }?>
                                    <br/>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6">
                                  <div class="input-group input-daterange">
                                    <input required="required" type="text" name="start_date" class="form-control" id="start_date" placeholder="1st Mar, 2015" value="<?php
											    echo $new_date;  ?>"/>
                                    <span class="input-group-addon">to</span>
                                    <input required="required" type="text" name="end_date" class="form-control" id="end_date" placeholder="03rd Mar ,2015" value="<?php echo $endnew_date; ?>"/>
                                  </div>
                                </div>
                              </div>
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  ...
                                  <div class="text-15px margin-top-10px"> <!--<img src="../images/homeslider/slide1_large.jpg" alt="Banner" class="img-responsive"><--><br/>
									...
									<?php if($details->enlarge_banner!='')
												 {?>
                                    <img alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/middletop/', $details->enlarge_banner?>" class="img-responsive" /> <br/>
                                  <br/>  
                                ...
                                <div class="col-md-9">
                                  ...
                                  <div id="pdf-data<?php echo $details->id; ?>" class="pdf-data">
                                    <?php if($details->pdf_link!='')
												 {?>
                                    <a href="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/middletop/', $details->pdf_link?>"><?php echo $details->pdf_link;?></a> <br/>
                              ...
                              <!--<input  type="submit" name="submit" value="submit" id="submit" />-->
                                <div class="col-md-offset-5 col-md-8"> <a href="#edit" onClick="chkSize('<?php echo $details->id; ?>');chkSizebanner('<?php echo $details->id; ?>');chkSizeenlargebanner('<?php echo $details->id; ?>');  editmiddletopbanner(<?php echo $details->id;  ?>);" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a  onClick="$('.form-horizontal').trigger('reset');" href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                              </div>
                            </form>
                          </div>
                        </div>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                              <form  name="deleteform" id="deleteform<?php echo $details->id; ?>" method="post" action="index_middle_top_list/deleteMiddleTopBanner" enctype="multipart/form-data" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <input type="hidden" name="method" value="deletetopbannerdata" id="deletetopbannerdata">
                                <input type="hidden" name="id" id="banner_id" value="<?php echo $details->id; ?>" />
                                <a onclick="javascript:document.getElementById('deleteform<?php echo $details->id; ?>').submit();" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a>
                              </form>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                              <form  name="delete_enlarge" id="delete_enlarge<?php echo $details->id; ?>" method="post" action="index_middle_top_list/delete_enlarge" enctype="multipart/form-data" class="delete_enlarge<?php echo $details->id; ?>" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <script>
											function deletemiddleopenlargeBanner<?php echo $details->id; ?>(){
												...
												$.ajax({			
													url: 'index_middle_top_list/delete_enlarge',
													type:'post',
													dataType:'json',
													data: form_data,
													enctype: 'multipart/form-data',
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                              <form  name="delete_pdf" id="delete_pdf<?php echo $details->id; ?>" method="post" action="index_middle_top_list/delete_enlarge" enctype="multipart/form-data" class="delete_enlarge<?php echo $details->id; ?>" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <script>
											function deletemiddle_top_pdfBanner<?php echo $details->id; ?>(){
												...
												$.ajax({			
													url: 'index_middle_top_list/delete_pdf',
													type:'post',
													dataType:'json',
													data: form_data,
													enctype: 'multipart/form-data',
...
<!--pdf trash data end-->   
            ...
            <script>
				function editmiddletopbanner(Id){
					var form_data = new window.FormData($('#editmiddletopbanner-'+Id)[0]);
												
					$.ajax({			
						url: 'index_middle_top_list/updateMiddleTopBanner',
						type:'post',
						dataType:'json',
						data: form_data,
						enctype: 'multipart/form-data',
						...
						success: function(response) {			
							if(response['error'])
							{
								$('#errorEditMiddleTopBanner').remove();
								$('#successEditMiddleTopBanner').remove();
								var error = '<div id="errorEditMiddleTopBanner" class="alert alert-danger"><i class="fa fa-times-circle"></i> <strong>Error!</strong>';
								...
								if(response['error']=='Please fill unique display order Field..'){
									...
									error += '</div>';
										$('#editmiddletopbanner-'+Id).before(error);	
								...
								if(response['success'])
								{
									$('#errorEditMiddleTopBanner').remove();
									$('#successEditMiddleTopBanner').remove();
									var success = '<div id="successEditMiddleTopBanner" class="alert alert-success"><i class="fa fa-check-circle"></i> <strong>Success!</strong><p>The information has been saved/updated successfully.<br />Page will be reload in 2 sec, Please Wait....</p></p></div>';
									$('#editmiddletopbanner-'+Id).before(success);
																
									$('.editmiddletopbanner-'+Id).live('load');
            ...
            <div class="tool-footer text-right">
              ...
              <ul class="pagination pagination mtm mbm">
			   ...
			   {$disabled1= '';} 
				echo "<li ".$disabled1."><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_middle_top_list?page=1>".'&laquo;'."</a></li> "; // Goto 1st page
			   ...
			   {$active= '';}
			echo "<li ".$active." ><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_middle_top_list?page=".$i.">".$i."</a></li> "; 
}; 
			if((isset($_GET['page'])&&($_GET['page']==$total_pages)) || $total_pages==1)
			   ...
			   {$disabled= '';}
            echo "<li ".$disabled."><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_middle_top_list?page=$total_pages>".'&raquo;'."</a></li> "; // Goto last page
?>
              </ul>
            </div>
            <div class="clearfix"></div>
