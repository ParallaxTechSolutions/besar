...
<div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
    <div class="page-header-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Video Title - Edit</li>
        </ol>
      </div>
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="video[first]" contenteditable="true">
                                {!! html_entity_decode($data[0]) !!}
                            </div>
                        </section><!--/.best-place-section-->
                        <form method="post" action="{{URL('/web88cms/video_title_editor')}}" id="wbx_change_info">
