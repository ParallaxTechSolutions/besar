         ...
         <div class="clearfix"></div>
            ...
            <div class="col-lg-12">
                ...
                <div class="portlet-header">
                  ...
                  <div class="btn-group">
                    <!--<div class="dropdown">-->
                      <button class="btn btn-danger dropdown-toggle" type="button" data-toggle="dropdown">Delete &nbsp;<span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <div class="text-15px margin-top-10px">
                                    ...
                                    <br/>
                                    <span class="help-block">(Image dimension: 1600 x 350 pixels, JPEG/GIF/PNG only, Max. 1MB) </span> </div>
                                </div>
                              </div>
                                ...
                                <div class="modal-dialog modal-wide-width">
                                  ...
                                  <input type="hidden" name="id" id="banner_id" value="<?php echo $details->id; ?>" />
                                        ...
                                        <?php if($details->banner!='')
												 {?>
                                        <img  alt="" src="<?php echo "https://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/left/', $details->banner?>" class="img-responsive" />
                                        <?php }?>
                                                <br/>
														...
														if(response['success'])
															{
																...
																$("#urlldata<?php echo $details->id; ?>").html('<input type="text" placeholder="https://" class="form-control" name="url" id="url<?php echo $details->id; ?>" onClick="urllink(<?php echo $details->id; ?>); return;"  />');
...
<!--pdf trash data end-->   
              ...
              <ul class="pagination pagination mtm mbm">
			   ...
			   {$disabled1= '';}
				echo "<li ".$disabled1."><a href= https://".$_SERVER['HTTP_HOST']."/web88cms/left_banner_list?page=1>".'&laquo;'."</a></li> "; // Goto 1st page
			   ...
			   {$active= '';}
			echo "<li ".$active." ><a href= https://".$_SERVER['HTTP_HOST']."/web88cms/left_banner_list?page=".$i.">".$i."</a></li> "; 
				}; 
			if((isset($_GET['page'])&&($_GET['page']==$total_pages)) || $total_pages==1)
			   ...
			   {$disabled= '';}
            echo "<li ".$disabled."><a href= https://".$_SERVER['HTTP_HOST']."/web88cms/left_banner_list?page=$total_pages>".'&raquo;'."</a></li> "; // Goto last page
?>
              </ul>
            </div>
              <div class="clearfix"></div>
