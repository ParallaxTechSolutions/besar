                    ...
                    <form id="save_notification_setting" method="POST" action="{{ url('web88cms/notification_settings_new') }}" >
    					...
    					<div class="portlet-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                  <input type="checkbox" name="activity[client_registered]" id="activity_client_registered" class="activity_checkbox" placeholder="" value=1 /> A new client has registered<br>
                                  <input type="checkbox" name="activity[new_order_received]" id="activity_new_order_received" class="activity_checkbox" placeholder="" value=1 /> A new order is received<br>
                                  <input type="checkbox" name="activity[room_running_low]" id="activity_room_running_low"  class="activity_checkbox" placeholder="" value=1 /> Room is running low<br>
                                  <input type="checkbox" name="activity[feedback_received]" id="activity_feedback_received"  class="activity_checkbox" placeholder="" value=1 /> A feedback is received<br>
                                  <input type="checkbox" name="activity[job_posting_expired]" id="activity_job_posting_expired"  class="activity_checkbox" placeholder="" value=1 /> A job posting expired<br>
                                  <input type="checkbox" name="activity[job_posting_will_expire]"  class="activity_checkbox" id="activity_job_posting_will_expire" placeholder="" value=1 /> A job posting will expire soon<br>
                                  <input type="checkbox"  class="activity_checkbox" name="activity[resume_submitted]" id="activity_resume_submitted" placeholder="" value=1 /> A resume is submitted<br>
                                  <input type="checkbox"  class="activity_checkbox" name="activity[room_active_for_booking]" id="activity_room_active_for_booking" placeholder="" value=1 /> No rooms have been active for booking<br>
                                </div>
                            </div>
