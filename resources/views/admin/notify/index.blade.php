                            ...
                            <table id="notify" class="table table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('web88cms/products/editProduct/' . $notify->product_id) }}">{{ $notify->bed}}</a></td>
                                        @if($notify->thumbnail_image_1)
                                        <td><img src="{{ asset('/public/admin/products/medium/' . $notify->thumbnail_image_1) }}" alt="{{ $notify->bed }}" class="img-responsive" width="100px"></td>
                                        @else
                                        <td><img src="{{ asset('/public/admin/products/no-image.jpg') }}" alt="{{ $notify->bed }}" class="img-responsive" width="100px"></td>
                                        @endif
