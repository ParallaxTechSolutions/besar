    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="portlet portlet-blue">
                    <div class="portlet-header">
                    	<div class="caption text-white">Search Orders By Book ID/Check in Date</div>
                    </div>
	                <div class="portlet-body">
    	            <form class="form-horizontal">
        		        <div class="form-group">
                			...
                			<div class="col-md-8">
				                <input type="text" name="order_id" value="{{ Input::get('order_id') }}" class="form-control" required oninvalid="this.setCustomValidity('Please Enter Book ID')">
			                </div>
            		    </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group input-daterange">
                                    <input type="text" name="check_from" class="form-control" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" value="{{ Input::get('check_from') }}" />
                                    <span class="input-group-addon">to</span>
                                    <input type="text" name="check_to" class="form-control" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" value="{{ Input::get('check_to') }}" />
                                </div>
                            </div>
                        </div>
		                <div class="form-actions text-center">
                        	<button type="submit" class="btn btn-red search-orders-by-bookId">Search &nbsp;<i class="fa fa-search"></i></button>
                        </div>
        	        </form>
                </div>
                </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-responsive mtl">
                            ...
                            <table id="example1" class="table table-hover table-striped">
                                <thead>
                                    <tr>
                                        <th width="1%"><input type="checkbox" autocomplete="off" onclick="$('input[type=checkbox]').prop('checked', $(this).is(':checked'))" /></th>
                                        <th>#</th>
                                ...
                                <tbody>
                                	@if($orders)
                                      	@foreach($orders as $order)
                                            <tr>
                                                <td><input name="order_id[]" autocomplete='off' class="chk-order" value="{{ $order->id }}" type="checkbox"/></td>
                                                <td>{{ $order->id }}</td>
