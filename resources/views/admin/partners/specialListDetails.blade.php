...
<div id="page-wrapper">
    <div class="page-header-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li><a href="{{ url('web88cms/partners/view/' . $specialList->user_id) }}">Special List Listing</a> &nbsp;<i class="fa fa-angle-right"></i>&nbsp;</li>
                    ...
                    <div id="specialList-details" class="tab-pane fade in active">
                        <div class="portlet">
	                        ...
	                        <div class="form-actions text-center"> 
		                        <a href="{{ url('web88cms/partners/view/' . $specialList->user_id) }}" class="btn btn-dark"><i class="fa fa-angle-double-left"></i> &nbsp;Back</a>
	                        </div>
                        </div>
                    </div>
                </div>
