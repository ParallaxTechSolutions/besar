        ...
        <div class="portlet-body">
          <form class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input type="text" name="type" id="typee" class="form-control" value="{{ Input::get('type') }}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label">Room Code </label>
              <div class="col-md-8">
                <input type="text" name="room_code" id="room_code" class="form-control" value="{{ Input::get('room_code') }}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label">Price From </label>
              <div class="col-md-8">
                <input type="text" name="price_from" id="price_from" class="form-control" placeholder="0.00" value="{{ Input::get('price_from') }}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label">Price To </label>
              <div class="col-md-8">
                <input type="text" name="price_to" id="price_to" class="form-control" placeholder="0.00" value="{{ Input::get('price_to') }}">
              </div>
            </div>
                  ...
                  <br/>
                    ...
                    <table class="table table-hover table-striped">
                      <thead>
                        ...
                        <tbody>
                          ...
                          foreach($products as $details)
                          {
                            ...
                            $dummyImage = asset('public/front/images/promotions/318_350.png');
                            ?>
                            <tr>
                             ...
                             <td>
                                 @if($details->thumbnail_image_1 != '')
                                     <img src="{{ asset('/public/admin/products/medium/' .$details->thumbnail_image_1) }}" alt="{{ $details->type }}" class="img-responsive" width="100px">
                                 @else
                                     <img src="{{$dummyImage}}" alt="{{ $details->type }}" class="img-responsive" width="100px">
                                @endif
                             </td>
                      ...
                      function uniquefun(val, sn)
                      {
                       ...
                       <form action="{{ url('/web88cms/products/updateorder') }}" name="myform" id="myform" method="post" enctype="multipart/form-data">
                            <input type="hidden" id="up_csrf_token" name="_token"  value="{{ csrf_token() }}" />
                            <?php
                            foreach($product_all_data as $details)
                              {?>
