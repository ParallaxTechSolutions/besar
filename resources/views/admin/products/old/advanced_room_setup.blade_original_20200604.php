                ...
                <div class="portlet-body">
                  ...
                  <br/>
                    ...
                    <form id="update_adv_room_data" method="post" enctype="multipart/form-data">
                                                  ...
                                                  <table class="each_product_roomprice_box" row_prp_id="{{$val3->id}}" width="100%" border="0" cellpadding="0" cellspacing="0">
                                                      <tbody>
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input name="update[{{$val3->id}}][qty_stock]" type="text" class="form-control text-12px qty_box" placeholder="Available Unit" value="{{$val3->qty_stock}}" data-hover="tooltip" data-placement="bottom" title="" style="width: 40px;" data-original-title="Available Unit">
                                                          </td>
                                                        </tr>

                                                      <tr>
                                                        <td><span class="badge badge-blue xss-margin" data-hover="tooltip" data-placement="bottom" title="" data-original-title="Booking Received">{{$val3->total_orders}}</span></td>
                                                        <td>
                                                          <input name="update[{{$val3->id}}][status]" type="hidden" class="update_status status_box" value="{{$val3->status}}" >
                                                          <a style="display: {{($val3->status != 1 ? 'none' : '')}}" class="btn-xs btn-success plm changeStatus" data-hover="tooltip" data-placement="bottom" title="" data-original-title="Open"></a>
                                                          <a style="display: {{($val3->status == 1 ? 'none' : '')}}" class="btn-xs btn-dark plm changeStatus" data-hover="tooltip" data-placement="bottom" title="" data-original-title="Closed"></a>
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                      ...
                      {{-- <div class="clearfix"></div> --}}
                      <div class="form-actions text-center" style="margin-top: 30px;"> <button class="btn btn-red tableSaveBtn">Save &nbsp;<i class="fa fa-save"></i></button> </div>
                      <?php
                    }
                    else
                    {
...
<script>
  $(document).ready(function(){
    ...
    $("#fixTable_wrapper").mouseover(function(){
      ...
      $(".DTFC_LeftBodyLiner").css("visibility", "visible");
    });
