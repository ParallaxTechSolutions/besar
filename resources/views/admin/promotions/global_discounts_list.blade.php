            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="pull-left"> Last updated: <span
                                class="text-blue"><?php echo date('d M, Y @ g:i A', strtotime($last_modified)); ?></span>
                    </div>
                    <div class="clearfix"></div>
                    <p></p>
                    <div class="clearfix"></div>
                ...
                <div class="col-lg-12">
                    <div class="portlet">
                        <div class="portlet-header">
                            ...
                            <a href="#" class="btn btn-success" data-target="#modal-add-discount" data-toggle="modal">Add
                                        ...
                                        <div class="modal-body">
                                            <div class="form">
                                                <form class="form-horizontal" id="form_add_global_discount">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputFirstName" class="col-md-3 control-label">From
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <div class="form-group">
                                                        <label for="inputFirstName" class="col-md-3 control-label">To
                                                            Amount <span class="text-red">*</span></label>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <div class="form-group">
                                                        <label for="inputFirstName" class="col-md-3 control-label">Discount
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputFirstName" class="col-md-3 control-label">Apply
                                                            to Category</label>
                                                        <div class="col-md-6">
                                                            <div class="xs-margin"></div>
                                                    ...
                                                    <div class="form-group" id="apply_to_all" style="display:none;">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="checkbox" id="select_products"> Apply discount
                                                            to all products under this category.
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="col-md-offset-5 col-md-8">
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn-red"
                                                               onclick="save_global_discount('modal-add-discount')">Save
                                                                &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a
                                                                    href="#" data-dismiss="modal" class="btn btn-green"
                                                                    onclick="$('#form_add_global_discount')[0].reset();">Cancel
                            ...
                            <div id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                                 aria-hidden="true" class="modal fade">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-actions">
                                                <div class="col-md-offset-4 col-md-8"><a href="javascript:void(0)"
                                                                                         onclick="continue_delete_process_global_discounts()"
                                                                                         class="btn btn-red">Yes
                                                        &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a
                                                            href="javascript:void(0)" data-dismiss="modal"
                                                            class="btn btn-green" onclick="cancel_delete()">No &nbsp;<i
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-actions">
                                                <div class="col-md-offset-4 col-md-8"><a href="javascript:void(0)"
                                                                                         onclick="delete_selected('global_discounts')"
                                                                                         class="btn btn-red">Yes
                                                        &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a
                                                            href="javascript:void(0)" data-dismiss="modal"
                                                            class="btn btn-green" onclick="cancel_delete()">No &nbsp;<i
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-actions">
                                                <div class="col-md-offset-4 col-md-8"><a href="javascript:void(0)"
                                                                                         onclick="delete_all('global_discounts')"
                                                                                         class="btn btn-red">Yes
                                                        &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a
                                                            href="javascript:void(0)" data-dismiss="modal"
                                                            class="btn btn-green" onclick="cancel_delete()">No &nbsp;<i
                            ...
                            <div id="modal-edit-discount" tabindex="-1" role="dialog"
                                 aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                <div class="modal-dialog modal-wide-width">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="form">
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="select" class="form-control">
                                                                ...
                                                                <option value="">&nbsp; &nbsp; &nbsp; ---Mini HiFi
                                                                </option>
                                                                <option value="">&nbsp; &nbsp; &nbsp; ---Micro HiFi
                                                                </option>
                                                                <option value="" selected="selected">&nbsp; &nbsp;
                                                                    &nbsp; ---Soundbar
                                                                </option>
                                                                <option value="">&nbsp; &nbsp; &nbsp; ---Home Theatrre
                                                                    System
                                                                </option>
                                                                <option value="">&nbsp; &nbsp; &nbsp; ---AV Component
                                                                </option>
                                                                <option value="">&nbsp; --TV</option>
                                                                <option value="">List all product category/sub category
                                                                    here.
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Apply to Products</label>
                                                        <div class="col-md-9"> note to programmer: display all related
                                                            products according to the category that admin selects above.
                                                            <input type="checkbox" checked="checked">
                                                            ...
                                                            <table class="table checkout-table table-responsive">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="item-name-col">
                                                                        <figure><a href="#link to product item"><img
                                                                                        src="../images/digital_gadget/digital_imaging/panasonic_DMC-GX1WGC_big1.jpg"
                                                                                        alt="Panasonic DMC-GX1WGC Camera Twin Lense (14MM F2.5 &amp; 14-42MM F3.5-5.6)"
                                                                                        class="img-responsive"></a>
                                                                        </figure>
                                                                        <header class="item-name"><a
                                                                                    href="#link to product item">Panasonic
                                                                                DMC-GX1WGC Camera Twin Lense (14MM F2.5
                                                                                &amp; 14-42MM F3.5-5.6)</a></header>
                                                                        <ul>
                                                                            <li>Color: Silver</li>
                                                                        </ul>
                                                                    </td>
                                                                    ...
                                                                    <td class="item-price-col"><span
                                                                                class="item-price-special">RM 670.<span
                                                                                    class="sub-price">00</span></span>
                                                                    </td>
                                                                    <td>1000</td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="item-name-col">
                                                                        <figure><a href="#link to product item"><img
                                                                                        src="../images/digital_gadget/digital_imaging/panasonic_DMC-GX1WGC_big2.jpg"
                                                                                        alt="Panasonic DMC-GX1WGC Camera Twin Lense (14MM F2.5 &amp; 14-42MM F3.5-5.6)"
                                                                                        class="img-responsive"></a>
                                                                        </figure>
                                                                        <header class="item-name"><a
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="col-md-offset-5 col-md-8"><a href="#"
                                                                ...
                                                                &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a
                                                                    href="#" data-dismiss="modal" class="btn btn-green">Cancel
                                                                &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a>
                                                        </div>
                                                    </div>
                                                </form>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-inline pull-left">
                                <div class="form-group">
                                    <select name="select" class="form-control"
                                            onchange="set_per_page(this.value,'global_discounts','{{ Request::path() }}','{{ $query_string }}')">
                                        <option <?php if ($per_page == 10) {
                                            echo 'selected="selected"';
                                        } ?>>10
                                        </option>
                                        <option <?php if ($per_page == 20) {
                                            echo 'selected="selected"';
                                        } ?>>20
                                        </option>
                                        <option <?php if ($per_page == 30) {
                                            echo 'selected="selected"';
                                        } ?>>30
                                        </option>
                                        <option <?php if ($per_page == 50) {
                                            echo 'selected="selected"';
                                        } ?>>50
                                        </option>
                                        <option <?php if ($per_page == 100) {
                                            echo 'selected="selected"';
                                        } ?>>100
                                        </option>
                                    </select>
                            ...
                            <div class="table-responsive mtl">
                                ...
                                <table id="example1" class="table table-hover table-striped">
                                    ...
                                    ?>
                                    <tr>
                                        <td><input type="checkbox" data-id="<?php echo $details->id; ?>"
                                                   class="select_items"/></td>
                                        <td>{{ $i }}</td>
                                        <td>{{ ($details->id < 10) ? '0'.$details->id : $details->id }}</td>
                                        <td>From RM {{ number_format($details->from_amount, 2) }} to
                                            RM {{ number_format($details->to_amount, 2)  }}</td>
                                        <td>{{ ($details->discount_by == 'percentage') ? number_format($details->discount, 2).'%' : 'RM '.number_format($details->discount,2) }}</td>
                                        <td><span class="label label-sm <?php echo $status_class; ?>"
                                                  id="brand-status-<?php echo $details->id; ?>"><?php echo $status; ?></span>
                                        </td>
                                        <td><a href="#" data-hover="tooltip" data-placement="top" title="Edit"
                                               data-target="#modal-edit-discount-<?php echo $details->id; ?>"
                                               data-toggle="modal"><span class="label label-sm label-success"><i
                                                            class="fa fa-pencil"></i></span></a> <a href="#"
                                                                                                    onclick="delete_item(<?php echo $details->id; ?>)"
                                                                                                    data-hover="tooltip"
                                                                                                    data-placement="top"
                                                                                                    title="Delete"
                                            ...
                                            <!--Modal edit discount start-->
                                            <div id="modal-edit-discount-<?php echo $details->id; ?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form">
                                                                <form class="form-horizontal"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div data-on="success" data-off="primary"
                                                                                 class="make-switch">
                                                                                <input type="checkbox"
                                                                                       name="status" <?php if ($details->status == '1') {
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" name="from_amount"
                                                                                   class="form-control"
                                                                                   placeholder="Amount"
                                                                                   value="{{ number_format($details->from_amount,2) }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="clearfix"></div>
                                                                    <div class="form-group">
                                                                        <label for="inputFirstName"
                                                                               class="col-md-3 control-label">To Amount
                                                                            <span class="text-red">*</span></label>
                                                                        <div class="col-md-6">
                                                                            <input type="text" name="to_amount"
                                                                                   class="form-control"
                                                                                   placeholder="Amount"
                                                                                   value="{{ number_format($details->to_amount,2) }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="clearfix"></div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" name="discount"
                                                                                   class="form-control"
                                                                                   placeholder="Amount"
                                                                                   value="{{ number_format($details->discount,2) }}">
                                                                            <div class="xs-margin"></div>
                                                                            <select name="discount_by"
                                                                                    class="form-control">
                                                                                <option value="percentage" <?php if ($details->discount_by == 'percentage') {
                                                                                    echo 'selected="selected"';
                                                                                } ?> >%
                                                                                </option>
                                                                                <option value="amount" <?php if ($details->discount_by == 'amount') {
                                                                                    echo 'selected="selected"';
                                                                                } ?>>RM
                                                                                </option>
                                                                            </select>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <select name="category_id"
                                                                                    class="form-control"
                                                                                    onchange="load_category_products('modal-edit-discount-<?php echo $details->id; ?>',this.value, '<?php $details->discount/100; ?>')">
                                                                    ...
                                                                    <div class="form-group"
                                                                         id="apply_to_all" <?php if (sizeof($category_products_list) == 0) {
                                                                        echo 'style="display:none;"';
                                                                    } ?>>
                                                                        <label class="col-md-3 control-label">Apply to
                                                                            Products</label>
                                                                        <div class="col-md-9">
                                                                            <input type="checkbox"
                                                                                   id="select_edit_products"
                                                                                   onclick="select_edit_products_list('modal-edit-discount-<?php echo $details->id; ?>')">
                                                                            Apply discount to all products under this
                                                                            category.
                                                                            ...
                                                                            <div id="category_products">
                                                                                <table class="table checkout-table table-responsive">
                                                                                    ...
                                                                                    <tr>
                                                                                        <th width="1%"></th>
                                                                                        <th class="table-title">Product
                                                                                            Name
                                                                                        </th>
                                                                                        <th class="table-title">Product
                                                                                            Code
                                                                                        </th>
                                                                                        <th class="table-title">Price
                                                                                        </th>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td><input type="checkbox"
                                                                                                   name="product_id[]"
                                                                                                   value="{{ $elm->id }}"
                                                                                                   class="select_products" <?php echo $checked; ?> />
                                                                                        </td>
                                                                                        <td class="item-name-col">
                                                                                            <figure>
                                                                                                <a href="#link to product item"><img
                                                                                                            src="<?php echo asset('/public/admin/products/large/' . $elm->large_image) ?>"
                                                                                                            alt="'{{ $elm->type }}"
                                                                                        ...
                                                                                        <td class="item-price-col"><span
                                                                                                    class="item-price-special"><!--RM {{ number_format(($elm->list_price-($details->discount*$elm->list_price)),2)}} -->
RM {{ number_format(($elm->list_price- ($elm->list_price*$details->discount/100)),2) }}                                                                                                     
                                                                                                   <!-- {{ number_format(($elm->list_price-(($details->discount/100)*$elm->list_price)),2)}}--></span>
                                                                                        </td>
                                                                    ...
                                                                    <div class="form-actions">
                                                                        <div class="col-md-offset-5 col-md-8">
                                                                            ...
                                                                            <a href="javascript:void(0)"
                                                                               onclick="update_global_discount('modal-edit-discount-<?php echo $details->id; ?>')"
        ...
        <div class="page-footer">
            <div class="copyright"><span class="text-15px">2015 &copy; <a href="http://www.webqom.com" target="_blank">Webqom Technologies Sdn Bhd.</a> Any queries, please contact <a
    ...
    <script>
        ...
        function load_category_products(model_id, category_id, discount) {
