...
<div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
  ...
  <div class="page-header-breadcrumb">
    <div class="page-heading hidden-xs">
      <h1 class="page-title">Pick Up List</h1>
    </div>
    
    
    <ol class="breadcrumb page-breadcrumb">
      <li><i class="fa fa-home"></i>&nbsp;<a href="{{ url('/web88cms/dashboard') }}">Dashboard</a>&nbsp; <i class="fa fa-angle-right"></i>&nbsp;</li>
      <li>Pick Up List &nbsp;<i class="fa fa-angle-right"></i>&nbsp;</li>
      <li class="active">Pick Up List- Listing</li>
    </ol>
  </div>
  ...
  <div class="page-content">
  		<div class="row">
  			<div class="col-lg-12">
		        <h2>Pick Up List <i class="fa fa-angle-right"></i> Listing</h2>
		    ...
		    <ul id="myTab" class="nav nav-tabs">
		        <li class="active"><a href="#brand-image" data-toggle="tab">Pick Up List Listing</a></li>
		    </ul>
		    	...
		    	<div id="brand-image" class="tab-pane fade in active">
		    		<div class="portlet">
		    			<div class="portlet-header">
				              <div class="caption">Pick Up List Listing</div>
				              <br/>
				              <p class="margin-top-10px"></p>
				              <button class="btn btn-success" data-toggle="modal" data-target="#modal-add-property">Add New Pick Up List &nbsp;<i class="fa fa-plus"></i></button>&nbsp;
				              <div class="btn-group">
				                   ...
				                   <div id="modal-delete-selected" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
				                    <div class="modal-dialog">
				                      <div class="modal-content">
				                        ...
				                        <div class="modal-body">
				                          <div class="form-actions">
				                            <div class="col-md-offset-4 col-md-8"> <a href="javascript:void(0)" onclick="delete_selected('property')" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="javascript:void(0)" data-dismiss="modal" onclick="cancel_delete()" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
				                          </div>
				                        </div>
				                      </div>
				                    </div>
				                  ...
				                  <div id="modal-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
				                    <div class="modal-dialog">
				                      <div class="modal-content">
				                        ...
				                        <div class="modal-body">
				                          <div class="form-actions">
				                            <div class="col-md-offset-4 col-md-8"> <a href="javascript:void(0)" onclick="delete_all('property')" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="javascript:void(0)" data-dismiss="modal" onclick="cancel_delete()"  class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
				                          </div>
				                        </div>
				                      </div>
				                    </div>
					                      ...
					                      <tbody>
					                      		@if(count($property) > 0)
					                      			@foreach($property as $p)
					                      				...
					                      				<tr>
					                      					<td><input type="checkbox" data-id="<?php echo $p->property_id; ?>" class="select_items"/></td>
					                      					<td>{{$p->property_id}}</td>
					                      					<td><span class="label label-sm <?php echo $status_class; ?>" id="brand-status-<?php echo $p->id; ?>"><?php echo $status; ?></span></td>
					                      					<td>{{$p->name}}</td>
					                      					<td>

					                      					<a class="edit_property" data-hover="tooltip" data-placement="top" title="Edit" data-id="{{$p->property_id}}" data-status="{{$p->status}}" data-name="{{$p->name}}" data-type="{{$p->type}}" data-address="{{$p->address}}" data-city="{{$p->city}}" data-postal_code="{{$p->postal_code}}" data-state="{{$p->state}}" data-country="{{$p->country}}" data-website_url="{{$p->website_url}}" data-telephone="{{$p->telephone}}" data-fax="{{$p->fax}}" data-administrative_email="{{$p->administrative_email}}" data-reservation_email="{{$p->reservation_email}}"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> 

					                      					<a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-<?php echo $p->property_id; ?>" data-toggle="modal" onclick="delete_item(<?php echo $p->property_id; ?>)"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
								                                 <!--Modal delete start-->
								                                 <div id="modal-delete-<?php echo $p->property_id; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
								                                  <div class="modal-dialog">
								                                    <div class="modal-content">
								                                     <div class="modal-header">
								                                       <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
								                                     ...
								                                     <div class="modal-body">
								                                       <p>Pick Up List Name : <?php echo $p->name; ?></p>
								                                        <div class="form-actions">
								                                          <div class="col-md-offset-4 col-md-8"> <a href="javascript:void(0)" class="btn btn-red" onclick="continue_delete_process_property()">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="javascript:void(0)" data-dismiss="modal" class="btn btn-green" onclick="cancel_delete()">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
								                                        </div>
								                                      </div>
								                                    </div>
								                                  </div>
      ...
      <div class="modal-dialog modal-wide-width">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 id="modal-login-label2" class="modal-title">Add New Pick Up List</h4>
          </div>
          <div class="modal-body">
            <div class="form">
              <form class="form-horizontal" method="post" id="add_property_info" action="{{ url('web88cms/property/manageproperty') }}">
                ...
                <h5>Pick Up List Information</h5>
                <hr>
  ...
  <div id="modal-edit-property" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade" style="display: none;">
      <div class="modal-dialog modal-wide-width">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" data-dismiss="modal" aria-hidden="true" class="close">×</button>
            <h4 id="modal-login-label2" class="modal-title">Edit Pick Up List</h4>
          </div>
          <div class="modal-body">
            <div class="form">
              <form class="form-horizontal" method="post" id="edit_property_info" action="{{ url('web88cms/property/manageproperty') }}">
...
$("#submitEditProperty").click(function(e){
 ...
 $(document).on('click',".edit_property",function(e){
	...
	$("#edit_property_id").val(self.attr("data-id"));
