...
<div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
    <div class="page-header-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Weddings - Edit</li>
        </ol>
      </div>
    <div class="page-content">
        <div class="row">
            <div class="col-lg-12">
                <h2>Weddings <i class="fa fa-angle-right"></i> Edit</h2>
                ...
                <div class="row">
                    ...
                    <div class="portlet">
                        <div class="portlet-header">
                            <div class="caption" style="float:none">Wedding Page Heading</div>
                            <br/>
               ...
               {{--  <div class="portlet">
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Wedding right Content </div>
                        <div class="clearfix"></div>
                        <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"><i class="fa fa-chevron-up"></i></div>
                    </div>
                    <div class="portlet-body">
                        <section class="best-place-section best-place-style-two">
                            <div class="wbx_info" name="data[]" contenteditable="true">
                                {!! html_entity_decode($data[0]) !!}
                            </div>
                        </section><!--/.best-place-section-->
                        <form method="post" action="{{URL('/web88cms/weddings_editor')}}" id="wbx_change_info_mid">
                          <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                        </form>
                    ...
                    <div class="form-actions none-bg">
                      <a href="#preview in browser/not yet published" target="_blank" class="wbx_submit_preview_mid btn btn-red">Save &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp;
                      <a href="#publish online" class="btn btn-blue wbx_submit_publish_mid">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i></a>&nbsp;
                      <a href="#" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a>
                    </div>
                    <!-- mid save button end -->
                </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="form">
                                                    <form action="{{ url('/web88cms/page_images_list') }}" method="POST"
                                                        ...
                                                        <input type="hidden" name="page" value="wedding">
                                            ...
                                            @if(isset($page_images) && !empty($page_images))
                                                @foreach ($page_images as $key => $value)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $value->type }}</td>
                                                        <td>
                                                            <img src="{{asset('/public/images/wedding/'.$value->image) }}" style="height:75px">
                                                        </td>
                                                        <td>{{ $value->order }}</td>
                                                                                ...
                                                                                <form class="form-horizontal" method="post"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <div class="text-15px margin-top-10px">
                                                                                                <?php if($value->image){?>
                                                                                                <img src="<?php echo "https://" . $_SERVER['HTTP_HOST'] . '/public/images/wedding/', $value->image?>"
                                                                                                     alt="Image"
