...
<!--BEGIN TO TOP--><a id="totop" href="#"><i class="fa fa-angle-up"></i></a><!--END BACK TO TOP-->
  <div id="wrapper"><!--BEGIN TOPBAR-->
                                ...
                                <div class="form">
                                    <form class="form-horizontal" id="updatePassword" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                            	<div class="input-icon"><i class="fa fa-key"></i> <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm New Password" class="form-control"/><span class="text-10px">(Password length should be between 6-12 characters)</span>                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
   ...
   <!-- <li class="sidebar-heading"><h4>CMS Pages</h4></li>-->
                   <!--  <li><a href="newsletter_subscription_list"><i class="fa fa-laptop fa-fw"></i><span class="menu-title">Newsletter</span></a></li>-->
                    <!-- <li><a href="dashboard"><i class="fa fa-laptop fa-fw"></i><span class="menu-title">Dashboard</span></a></li> -->

                  	<!-- InstanceBeginEditable name="EditRegion3" -->
           <!--         <li><a href="aboutusEdit"><i class="fa fa-user fa-fw"></i><span class="menu-title">About Us</span></a> </li>
                    <li  id="wbx-careers"><a href="vacancy"><i class="fa fa-briefcase fa-fw"></i><span class="menu-title">Careers</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="vacancy">Vacancies Listing</a></li>
                            <li><a class="ch-careers" href="applicants">Online Applicants Listing</a></li>
                        </ul>
                    </li>-->
					<!--<li><a href="services"><i class="fa fa-tags fa-fw"></i><span class="menu-title">Our Services</span></a> </li>-->
					<!--<li><a href="stores"><i class="fa fa-map-marker fa-fw"></i><span class="menu-title">Our Stores</span></a> </li>-->
              <!--      <li><a href="contact"><i class="fa fa-phone fa-fw"></i><span class="menu-title">Contact Us &amp; Feedback</span></a> </li> -->
				  <!-- InstanceEndEditable -->

                    <!-- <li><a href="bottom_animated_services_list"><i class="fa fa-cogs fa-fw"></i><span class="menu-title">Animated Services Icons</span></a></li> -->
                    ...
                    <li @if(Request::path() == 'web88cms/orders/shipmentsList' || Request::path() == 'web88cms/orders' ) class="active" @endif ><a href="#"><i class="fa fa-shopping-cart fa-fw"></i><span class="menu-title">Bookings</span>
                        ...
                        <ul @if(Request::path() == 'web88cms/orders/shipmentsList' || Request::path() == 'web88cms/orders' || Request::path() == 'web88cms/settings' || Request::path() == 'web88cms/analytics_reports' || Request::path() == 'web88cms/checkInOut') class="nav nav-second-level collapse in" style="height: auto;" @else class="nav nav-second-level collapse" @endif>
                            <li @if(Request::path() == 'web88cms/orders') class="active" @endif><a href="{{ url('web88cms/orders') }}">View All Bookings</a></li>
                            <li @if(Request::path() == 'web88cms/room_sales_list') class="active" @endif><a href="{{ url('web88cms/room_sales_list') }}">Room Sales Report</a></li>
                            <li @if(Request::path() == 'web88cms/settings') class="active" @endif><a href="{{ url('web88cms/settings') }}">DRR Settings</a></li>
                            <li @if(Request::path() == 'web88cms/sold_rooms_per_available') class="active" @endif><a href="{{ url('web88cms/sold_rooms_per_available') }}">Sold Rooms Per Available Settings</a></li>
                            <li @if(Request::path() == 'web88cms/analytics_reports') class="active" @endif><a href="{{ url('web88cms/analytics_reports') }}">Google Analytics Reports</a></li>
                            <li @if(Request::path() == 'web88cms/checkInOut' ) class="active" @endif ><a href="{{ url('web88cms/checkInOut') }}">Checking In/Out Listing</a></li>
                            <li @if(Request::path() == 'web88cms/calendar_view' ) class="active" @endif ><a href="{{ url('web88cms/calendar_view') }}">Calendar View</a></li>
                    ...
                    <li @if(preg_match('/check_ota_rate/',$current_route)) class="active" @endif><a href="{{ url('/web88cms/check_ota_rate/') }}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Check OTA Rate</span></a></li>


                    <li class="sidebar-heading"><h4>Customers</h4></li>
                    @if(Auth::user()->role()->first()->role == 'admin')
                        <li class="{{ Request::path() == 'web88cms/administrators' || Request::path() == 'web88cms/activiy_logs_list' ? 'active' : ''}}"><a href="#"><i class="fa fa-cog fa-fw"></i><span class="menu-title">Administrators</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse {{ Request::path() == 'web88cms/administrators' or Request::path() == 'web88cms/activiy_logs_list' ? 'in' : ''}}" style="height: auto;">
                                <li @if(Request::path() == 'web88cms/administrators') class="active" @endif><a href="{{ url('web88cms/administrators/?0=&page=1') }}"><!-- <span class="menu-title"> -->Administrators<!-- </span> --></a> </li>
                                <li  class="{{ Request::path() == 'web88cms/activiy_logs_list' ? 'active' : '' }}"><a href="{{ url('web88cms/activiy_logs_list/') }}">Activity Logs Listing</a></li>
                            </ul>
                        </li>
					@else
                    ...
                    <li @if(Request::path() == 'web88cms/partners') class="active" @endif><a href="{{ url('web88cms/partners') }}"><i class="fa fa-user fa-fw"></i><span class="menu-title">Partners</span></a></li>
                    ...
                    {{-- <li @if(Request::path() == 'web88cms/about_us_edit') class="active" @endif><a href="{{ url('/web88cms/about_us_edit') }}"><i class="fa fa-user fa-fw"></i><span class="menu-title">About Us</span></a></li> --}}
                    {{-- <li @if(Request::path() == 'web88cms/dining_edit') class="active" @endif><a href="{{ url('/web88cms/dining_edit') }}"><i class="fa fa-cutlery fa-fw"></i><span class="menu-title">Dining</span></a></li> --}}
                    {{-- <li @if(Request::path() == 'web88cms/promocodes') class="active" @endif><a href="{{ url('/web88cms/promocodes/?0=&page=1') }}"><i class="fa fa-coffee fa-fw"></i><span class="menu-title">Promotions</span></a></li> --}}
                   {{--  <li @if(Request::path() == 'web88cms/newsletter') class="active" @endif><a href="{{ url('/web88cms/newsletter') }}"><i class="fa fa-star fa-fw"></i><span class="menu-title">Facilities</span></a> </li>
                    <li @if(Request::path() == 'web88cms/newsletter') class="active" @endif><a href="{{ url('/web88cms/newsletter') }}"><i class="fa fa-calendar fa-fw"></i><span class="menu-title">Events & Meetings</span></a> </li> --}}
                    {{-- <li @if(Request::path() == 'web88cms/newsletter') class="active" @endif><a href="{{ url('/web88cms/newsletter') }}"><i class="fa fa-youtube fa-fw"></i><span class="menu-title">Videos</span></a> </li> --}}
                    {{-- <li @if(Request::path() == 'web88cms/newsletter') class="active" @endif><a href="{{ url('/web88cms/newsletter') }}"><i class="fa fa-calendar fa-fw"></i><span class="menu-title">Room Hedaer</span></a> </li> --}}
					...
					<li @if(preg_match('/listProducts/',$current_route)) class="active" @endif><a href="{{ url('/web88cms/products/list/') }}"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Services</span></a></li>

                    <li @if(preg_match('/advancedRoomSetup/',$current_route)) class="active" @endif><a href="{{ url('/web88cms/products/advanced_room_setup/') }}"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Advanced room setup</span></a></li>

                    <li @if(preg_match('/PropertiesController/',$current_route)) class="active" @endif><a href="{{ url('/web88cms/property') }}"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Pick Up List</span></a></li>
                    <li @if(preg_match('/DropOffController/',$current_route)) class="active" @endif><a href="{{ url('/web88cms/drop-off-list') }}"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Drop Off List</span></a></li>
                ...
                <!-- <li class="sidebar-heading"><h4>Shipping Setup</h4></li>
                    ...
                    <li class="sidebar-heading"><h4>CMS Pages</h4></li>
                   {{--  <li><a href="{{ url('web88cms/index_edit') }}"><i class="fa fa-home"></i><span class="menu-title">Index</span></a> </li>
 --}}
                    <li @if(Request::path() == 'web88cms/index_edit' || Request::path() == 'web88cms/index_edit_second' || Request::path() == 'web88cms/index_edit_third' || Request::path() == 'web88cms/index_edit_fourth' || Request::path() == 'web88cms/facilities_edit' || Request::path() == 'web88cms/video_title_edit') class="active" @endif ><a href="#"><i class="fa fa-home fa-fw"></i><span class="menu-title">Index</span>
                            <span class="fa arrow"></span>
                        </a>

                        <ul @if(Request::path() == 'web88cms/index_edit' || Request::path() == 'web88cms/index_edit_second' || Request::path() == 'web88cms/index_edit_third' || Request::path() == 'web88cms/index_edit_fourth' || Request::path() == 'web88cms/facilities_edit' || Request::path() == 'web88cms/video_title_edit') class="nav nav-second-level collapse in" style="height: auto;" @else class="nav nav-second-level collapse" @endif>
                            <li @if(Request::path() == 'web88cms/index_edit') class="active" @endif><a href="{{ url('/web88cms/index_edit') }}">Living Experience</a></li>
                            <li @if(Request::path() == 'web88cms/index_edit_second') class="active" @endif><a href="{{ url('web88cms/index_edit_second') }}">Rooms Heading</a></li>
                            <li @if(Request::path() == 'web88cms/video_title_edit') class="active" @endif><a href="{{ url('web88cms/video_title_edit') }}">Video Heading</a></li>
                            <li @if(Request::path() == 'web8thirdndex_edit_second') class="active" @endif><a href="{{ url('web88cms/index_edit_third') }}">Banquets</a></li>
                            <li @if(Request::path() == 'web88cms/index_edit_fourth') class="active" @endif><a href="{{ url('web88cms/index_edit_fourth') }}">Promotions </a></li>

                        </ul>
                  </li>


                    <li><a href="{{ url('/web88cms/promotions_list') }}"><i class="fa fa-coffee fa-fw"></i><span class="menu-title">Promotions</span></a> </li>
                    <li><a href="{{ url('web88cms/about_us_edit') }}"><i class="fa fa-user"></i><span class="menu-title">About Us</span></a> </li>
                    <li><a href="{{ url('web88cms/gallery_list') }}"><i class="fa fa-user"></i><span class="menu-title">Gallery</span></a> </li>
                    <li><a href="{{ url('web88cms/dining_edit') }}"><i class="fa fa-cutlery"></i><span class="menu-title">Dining</span></a> </li>
                    <li><a href="{{ url('web88cms/facilities_edit') }}"><i class="fa fa-star"></i><span class="menu-title">Facilities</span></a> </li>
                    <li id="wbx-event"  @if(Request::path() == 'web88cms/weddings_edit') class="active" @endif>
                        <a href="#"><i class="fa fa-calendar fa-fw"></i><span class="menu-title">Events &amp; Meetings</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse in" style="height: auto;">
                            <li @if(Request::path() == 'web88cms/weddings_edit') class="active" @endif><a href="{{ url('web88cms/weddings_edit') }}">Weddings</a></li>
                            <li @if(Request::path() == 'web88cms/events_edit') class="active" @endif><a href="{{ url('web88cms/events_edit') }}">Events &amp; Meetings</a></li>
                        </ul>
                    </li>
                    ...
                    <li @if(Request::path() == 'web88cms/contacts/feedbacks') class="active" @endif><a href="{{ url('/web88cms/contacts/feedbacks') }}"><i class="fa fa-pencil-square fa-fw"></i><span class="menu-title">Taxi Services Feedback</span></a></li>

                    <li class="sidebar-heading"><h4>Global Setup</h4></li>
                    <li @if(Request::path() == 'web88cms/indexPopup') class="active" @endif><a href="{{ url('/web88cms/indexPopup') }}"><i class="fa fa-check-circle"></i><span class="menu-title">Index Pop Up</span></a></li>
                    <li @if(Request::path() == 'web88cms/loader') class="active" @endif><a href="{{ url('/web88cms/loader') }}"><i class="fa fa-check-circle"></i><span class="menu-title">Loader</span></a></li>
                    <li @if(Request::path() == 'web88cms/onScreenMessages') class="active" @endif><a href="{{ url('/web88cms/onScreenMessages') }}"><i class="fa fa-check-circle"></i><span class="menu-title">On-Screen Messages</span></a></li>
                    <li @if(preg_match('/GstratesController/',$current_route)) class="active" @endif ><a href="{{ url('/web88cms/taxrates') }}"><i class="fa fa-cog fa-fw"></i><span class="menu-title">Tax Rates</span></a></li>
                    <li @if(Request::path() == 'web88cms/notifications' || Request::path() == 'web88cms/notification_settings_new' || Request::is('web88cms/notifications/*/edit') ) class="active" @endif><a href="{{ url('/web88cms/notifications') }}"><i class="fa fa-check-circle"></i><span class="menu-title">Notifications Settings</span></a></li>
                    <li><a href="{{ url('web88cms/paymentGateWays') }}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Payment GateWays Setup</span></a></li>
                    <li><a href="{{ url('web88cms/header_setup') }}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Header Setup</span></a></li>
                    <li><a href="{{ url('web88cms/footer_setup') }}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Footer Setup</span></a></li>
              </ul>
          </div>
    </nav>
        <!--END SIDEBAR MENU-->
...
{{-- <script src="http://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.2/modernizr.js" defer></script> --}}
