...
<section class="online-book-section style-two">
    ...
    left: 0;">
            ...
            <div class="col-md-9 form-content">
                ...
                <form action="{{ url('check-availability-search')}}" method="get" id="online-book-form"
                    style="padding-left: 15px;padding-top: 15px;">
                    <div class="row">
                        <div class="col-md-2 col-lg-2 padding-left">
                            <label class="text-uppercase">Property</label>
                            <div class="input box-radius">
                                <!-- <i class="fa fa-caret-down"></i> -->
                                <select name="property">
                                    @foreach($properties as $key => $val)
                                    <option @if($val->property_id == $property) selected @endif value="{{$val->property_id}}">{{$val->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!--/.input-->
                        ...
                        <div class="col-md-2 col-lg-2 padding-left">
                            ...
                            <div class="input box-radius"><i class="fa fa-calendar"></i>
                                <input type="text" name="arrival" value="{{$arrival}}" id="date-arrival" placeholder="Check-in Date"
                        ...
                        <div class="col-md-2 col-lg-2 padding-left">
                            ...
                            <div class="input box-radius"><i class="fa fa-calendar"></i>
                                <input type="text" name="departure" value="{{$departure}}" id="date-departure" placeholder="Check-out Date"
                                    class=" form-controller">
                            </div>
                            <!--/.input-->
                        </div>
                        ...
                        <div class="col-md-2 col-lg-1 padding-left">
                            ...
                            <div class="input box-radius">
                                ...
                                <select name="room">
                                    @for ($i= 1; $i < 11; $i++)
                                    <option @if($i == $room) selected @endif  value="{{$i}}">{{$i}}</option>
                                    @endfor
                                </select>
                            </div>
                            <!--/.input-->
                        ...
                        <div class="col-md-2 col-lg-1 padding-left">
                            ...
                            <div class="input box-radius">
                                ...
                                <select name="adult">
                                    @for ($i= 1; $i < 11; $i++)
                                    <option @if($i == $adult) selected @endif  value="{{$i}}">{{$i}}</option>
                                    @endfor
                                </select>
                            </div>
                            <!--/.input-->
                        ...
                        <div class="col-md-2 col-lg-2 padding-left">
                            ...
                            <div class="input box-radius">
                                ...
                                <select name="childrens">
                                    @for ($i= 1; $i < 11; $i++)
                                    <option @if($i == $childrens) selected @endif  value="{{$i}}">{{$i}}</option>
                                    @endfor
                                </select>
                            </div>
                            <!--/.input-->
    ...
    $(document).ready(function () {
        ...
        jQuery('#online-book-form-btn').click(function () {
            if (jQuery('#date-arrival').val() == '' || jQuery('#date-departure').val() == '') {
                jQuery('.modal-text').text('Please insert the Check-in Date and Check-out Date.');
                jQuery('#modal-validation').modal('show')
            } else {
                // return true;
