                                    ...
                                    <td class="item-name-col">
                                        <figure><a href="{{ url('/product/' . $orderProduct->id) }}">
                                          ...
                                          @if($orderProduct->promo_behaviour === 'sale')
                                                <img class="promo" src="{{ asset('public/promo/sale_label.png') }}" style="position: relative; !important;top: 682px !important;left: -945px !important;width: 35px !important;height: 35px !important;">
                                                @elseif($orderProduct->promo_behaviour === 'hot')
                                                <img class="promo" src="{{ asset('public/promo/hot_label.png') }}" style="position: relative; !important;top: 682px !important;left: -945px !important;width: 35px !important;height: 35px !important;">
                                                @elseif($orderProduct->promo_behaviour === 'new')
                                                <img class="promo" src="{{ asset('public/promo/new_label.png') }}" style="position: relative; !important;top: 682px !important;left: -945px !important;width: 35px !important;height: 35px !important;">
                                                @elseif($orderProduct->promo_behaviour === 'pwp')
                                                <img class="promo" src="{{ asset('public/promo/pwp_label.png') }}" style="position: relative; !important;top: 682px !important;left: -945px !important;width: 35px !important;height: 35px !important;">
                                                @endif
                                        </figure>
