                      ...
                      <div class="col-md-12">
                        <form action="#" method="post" id="comment_form" name="commentForm">
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 padding-right">
                              <p>
                                <input type="text" name="passport_nric" id="passport_nric" aria-required="true" placeholder="Passport/NRIC *" class="form-controllar">
                              </p>
                            </div><!--/.col-md-6-->
                            <div class="col-md-6 col-sm-6 padding-right">
                              <p>
                                <input type="text" name="email" id="email" aria-required="true" placeholder="Your Email (Login ID) *" class="form-controllar">
                              </p>
                            </div><!--/.col-md-6-->
                            ...
                            <div class="col-md-6 col-sm-6 padding-right">
                              <p>
                                <input type="password" name="Password" id="verify-password" aria-required="true" placeholder="Verify Password *" class="form-controllar">
                              </p>
                            </div><!--/.col-md-6-->
                              ...
                              <p>
                                <div class="input box-radius">
                                    <select name="room">
                                      ...
                                      <option value="Negri Sembilan">Negeri Sembilan</option>
         ...
         <div class="row">
         	<div class="col-md-12">
            	...
            	<p><div class="input-group custom-checkbox">
                                 <input type="checkbox" checked="checked"> Yes! I would like to subscribe to Ritz Garden Hotel's newsletter to receive latest offers, promotions, discounts and FREE gifts.
                                </div></p>
                                
                              <p><div class="input-group custom-checkbox">
                                 <input type="checkbox" checked="checked"> I agree Ritz Garden Hotel's <a href="#">terms &amp; conditions</a>, <a href="#">privacy policy</a>
                                </div></p>
            	...
            	<div class="pull-left">
                    <p><a href="#" class="btn btn-default">Create an Account Now</a></p>
                </div>
