          ...
          <div class="col-md-6 title">
            <div class="section-align-title-area">
              <div class="section-title-style-inner">
                <h3 class="section-name">A Towering Achievement</h3>
                <h2 class="section-align-title">A Uniquely Sophisticated Living Experience</h2>
                <p class="section-title-dec">Strategically located within the main business hub of Ipoh city centre, Tower Regency Hotel &amp; Apartments combine refined luxury with unparalleled accessibility to provide a uniquely sophisticated living experience. </p><a href="{{url('/about-us/12')}}" class="btn btn-default">About more</a>
