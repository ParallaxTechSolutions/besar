          ...
          <div class="col-md-8 room-single-content">
            <div class="room-single-thumb">
              ...
              @foreach($images as $image)
                <div class="item"><img src="{{ asset('public/admin/products/large/'.$image->file_name) }}" alt="premier room"></div>
			        @endforeach
              </div>
              ...
              <div class="room-info">
                ...
                <div class="room-service-area clearfix">
                  <ul class="room-services list-unstyled">
                    ...
                    <li><i class="fa fa-thermometer"></i>Individually controllable Air-conditioning</li>
                    @endif
                    ...
                    <li><i class="fa fa-eye"></i>Awesome View</li>
                      ...
                      <li><i class="fa fa-television"></i>Television with Astro channels</li>
                      @endif
                      ...
                      <li><i class="fa fa-check-circle-o"></i>Comfortable sitting room with sofa &amp; dining table </li>
                      @endif
