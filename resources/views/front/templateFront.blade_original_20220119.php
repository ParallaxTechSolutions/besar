...
<!--<![endif]--><head>
    ...
    <!--================= Page Title ======================-->
    <title>A Uniquely Sophisticated Living Experience | Tower Regency Hotel | Ipoh Hotel | Hotel &amp; Apartments</title>
    <!--================= Favicons ========================-->
    <!--================= Favicons ========================-->
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <a href="{{ url('dashboard') }}">Dashboard</a> | Welcome, &nbsp;{{ Session::get('userFirstName') }} {{ Session::get('userLastName') }}! <a href="{{ url('/logout')}}">Logout</a>
                ...
                @endif
         <a href="https://www.facebook.com/Towerreg" target="_blank"><i class="fa fa-facebook"></i></a></div><!--/.social-links-->
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="menu-wrapper clearfix">
				...
				<div class="logo-block"><a href="{{url('/')}}" class="site-logo"><img src="{{ asset('/public/front/images/index/logo.png') }}" alt="Tower Regency Hotel &amp; Apartments" class="logo"></a><!--/.site-logo--></div>
                </div><!--/.navbar-header-->
            ...
            <div class="col-sm-6 col-md-4">
              <div class="widget-area footer-sidebar-2">
                <aside class="widget clearfix widget_instafeed">
                  <div class="widget-title-area">
                    <h4 class="widget-title">Hotel Location</h4>
                  </div><!--/.widget-title-area-->
