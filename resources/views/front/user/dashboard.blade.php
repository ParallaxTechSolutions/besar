                      ...
                      <div class="col-md-12">
                         <div class="alert alert-success">
							...
							<div class="col-md-6 col-sm-6">
                                          <p><div class="alert alert-warning"><i class="fa fa-star"></i> &nbsp;<strong>Membership No.:</strong> 708658819</div></p>
                                        </div><!--/.col-md-6-->
                                        <div class="col-md-6 col-sm-6">
                                          <p><div class="alert alert-warning"><i class="fa fa-user-o"></i> &nbsp;<strong>Membership Type:</strong> Classic / VIP / VVIP</div></p>
                                        </div><!--/.col-md-6-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="room-description clearfix">
                                                 ...
                                                 @if($newsletterStatus==1)
                                                	<p>You are currently subscribed to Tower Regency Hotel &amp; Apartments newsletter.</p>
                                                @else
                                                	<p>You are not subscribed to Tower Regency Hotel &amp; Apartments newsletter.</p>
                                                @endif
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body clearfix">
                                                                <div class="input-group custom-checkbox">
                                                                    <input type="radio" name="nwslttr" value="subscribe" @if($newsletterStatus==0) 'checked="checked"' @endif> <span class="radio-container"><i class="fa fa-radio"></i></span>Yes, I would like to subscribe to Tower Regency Hotel &amp; Apartments newsletter.</div>
                                                                <div class="input-group custom-checkbox">
