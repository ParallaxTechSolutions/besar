...
<div style="padding:0px; margin:0px;">
    <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:10px; background:#fff;">
       ...
       @if(!empty($packages))
        ...
        <tr>
          <td colspan="2" align="left" valign="top">Property : {{$property_name}}</td>
        </tr>
        <tr>
          <td colspan="2" align="left" valign="top">Check-in : {{date('dS F, Y', strtotime($order->check_date->date_checkin))}}</td>
        </tr>
        <tr>
          <td colspan="2" align="left" valign="top">Check-out : {{date('dS F, Y', strtotime($order->check_date->date_checkout))}}</td>
        </tr>
        <tr>
